<div class="container">
    <div class="row">
        ...
        <p>Hans Vochel<br/>
            Irgendwas 7<br/> 04109 Leipzig </p>
        <h2>Vertreten durch:</h2>
        <p>Hans Vochel Senior</p>
        <h2>
            Kontakt:</h2>
        <table>
            <tr>
        ...
        <h2>
            Registereintrag:</h2>
        <p>Eintragung im Handelsregister. <br/>Registergericht:Leipzig <br/>
            Registernummer: 123123</p>
        <p>Umsatzsteuer-Identifikationsnummer gem&auml;&szlig; &sect;27 a
            Umsatzsteuergesetz:<br/> 123123123123</p>
        <h2>Aufsichtsbeh&ouml;rde:</h2>
        <p>Wees ick nich</p>
        <h2>Verantwortlich f&uuml;r den Inhalt nach &sect; 55 Abs. 2 RStV:</h2>
        <p>Hans Vochel</p>
        <p>Die
            Europ&auml;ische Kommission stellt eine Plattform zur
        ...
        <p>Als Diensteanbieter sind wir gem&auml;&szlig; &sect; 7 Abs.1 TMG f&uuml;r
            ...
            verantwortlich. Nach &sect;&sect; 8 bis
        ...
        <p>Verpflichtungen zur Entfernung oder Sperrung der Nutzung von
            ...
            Eine diesbez&uuml;gliche
            Haftung ist jedoch erst ab dem Zeitpunkt der Kenntnis einer
            konkreten Rechtsverletzung m&ouml;glich.
        ...
        <p>Unser Angebot enth&auml;lt Links zu externen
            ...
            Deshalb k&ouml;nnen wir f&uuml;r diese
        ...
        <p>Die durch die Seitenbetreiber erstellten Inhalte und Werke auf
            diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielf&auml;ltigung,
            Bearbeitung,
            Verbreitung und jede Art der Verwertung au&szlig;erhalb der Grenzen
            des Urheberrechtes bed&uuml;rfen
